...
namespace YG
{
    public static partial class YG2
    {
        ...
        public static void SetDefaultSaves()
        {
            ...
            int idSave = saves.PlayerWallet;
            saves = new SavesYG { PlayerWallet = idSave };
...
namespace YG.Insides
{
    public static partial class YGInsides
    {
        ...
        public static void SetLoadSaves(string data)
        {
            ...
            {
                if (cloudData.PlayerWallet >= localData.PlayerWallet)
                {
                    Message($"Load Cloud Complete! ID Cloud Save: {cloudData.PlayerWallet}, ID Local Save: {localData.PlayerWallet}");
                    YG2.saves = cloudData;
                }
                else
                {
                    Message($"Load Local Complete! ID Cloud Save: {cloudData.PlayerWallet}, ID Local Save: {localData.PlayerWallet}");
                    YG2.saves = localData;
                }
            }
